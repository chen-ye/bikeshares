...
export default class OrbitViewport extends Viewport {
  constructor({
    ...
    if (orbitAxis === 'Z') {
      vec3_rotateZ(upVector, up, lookAt, rotationOrbit / 180 * Math.PI);
    } else {
      vec3_rotateY(eye, eye, lookAt, rotationOrbit / 180 * Math.PI);
    }
    ...
    super({
      viewMatrix: mat4_lookAt([], eye, lookAt, upVector),
