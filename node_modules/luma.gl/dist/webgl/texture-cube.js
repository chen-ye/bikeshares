...
var FACES = [_glConstants.GL.TEXTURE_CUBE_MAP_POSITIVE_X, _glConstants.GL.TEXTURE_CUBE_MAP_NEGATIVE_X, _glConstants.GL.TEXTURE_CUBE_MAP_POSITIVE_Y, _glConstants.GL.TEXTURE_CUBE_MAP_NEGATIVE_Y, _glConstants.GL.TEXTURE_CUBE_MAP_POSITIVE_Z, _glConstants.GL.TEXTURE_CUBE_MAP_NEGATIVE_Z];
...
var TextureCube = /*#__PURE__*/function (_Texture) {
  ...
  function TextureCube(gl) {
    ...
    var _this = _possibleConstructorReturn(this, (TextureCube.__proto__ || Object.getPrototypeOf(TextureCube)).call(this, gl, Object.assign({}, opts, { target: _glConstants.GL.TEXTURE_CUBE_MAP })));
  ...
  _createClass(TextureCube, [{
    ...
    value: function initialize() {
      ...
      var _opts$format = opts.format,
          format = _opts$format === undefined ? _glConstants.GL.RGBA : _opts$format,
      ...
      var _opts$width = opts.width,
          ...
          type = _opts$type === undefined ? _glConstants.GL.UNSIGNED_BYTE : _opts$type,
      ...
      var _deduceImageSize = this._deduceImageSize({
        data: opts[_glConstants.GL.TEXTURE_CUBE_MAP_POSITIVE_X], width: width, height: height
      });

      width = _deduceImageSize.width;
      height = _deduceImageSize.height;
      (0, _assert2.default)(width === height);
    ...
    value: function setCubeMapImageData(_ref2) {
      var width = _ref2.width,
          ...
          format = _ref2$format === undefined ? _glConstants.GL.RGBA : _ref2$format,
          _ref2$type = _ref2.type,
          type = _ref2$type === undefined ? _glConstants.GL.UNSIGNED_BYTE : _ref2$type,
    ...
    value: function bind() {
      ...
      if (index !== undefined) {
        this.gl.activeTexture(_glConstants.GL.TEXTURE0 + index);
      }
      this.gl.bindTexture(_glConstants.GL.TEXTURE_CUBE_MAP, this.handle);
      return index;
    }
  }, {
    key: 'unbind',
    value: function unbind() {
      this.gl.bindTexture(_glConstants.GL.TEXTURE_CUBE_MAP, null);
      return this;
    }
  }]);
