...
function readPixels(gl, _ref) {
  var x = _ref.x,
      ...
      format = _ref$format === undefined ? _api2.default.RGBA : _ref$format;
...
function readPixelsToBuffer(gl, _ref2) {
  var x = _ref2.x,
      ...
      type = _ref2$type === undefined ? _api2.default.UNSIGNED_BYTE : _ref2$type,
      sourceHeight = _ref2.sourceHeight,
      _ref2$format = _ref2.format,
      format = _ref2$format === undefined ? _api2.default.RGBA : _ref2$format;
  ...
  gl.bindBuffer(_api2.default.PIXEL_PACK_BUFFER, buffer.handle);

  gl.readPixels(x, y, width, height, format, type, dataOffset);

  gl.bindBuffer(_api2.default.PIXEL_PACK_BUFFER, null);
...
function blitFramebuffer(gl, _ref3) {
  var _ref3$source = _slicedToArray(_ref3.source, 4),
      ...
      mask = _ref3$mask === undefined ? _api2.default.COLOR_BUFFER_BIT | _api2.default.DEPTH_BUFFER_BIT | _api2.default.STENCIL_BUFFER_BIT : _ref3$mask,
      _ref3$filter = _ref3.filter,
      filter = _ref3$filter === undefined ? _api2.default.LINEAR : _ref3$filter;
}
